...
// tslint:disable-next-line: max-line-length
var GridSizer = /*#__PURE__*/ (function (_super) {
    __extends(GridSizer, _super);
    function GridSizer() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.ref = createRef();
        return _this;
    }
    GridSizer.prototype.componentDidUpdate = function () {
        var _a = this.props.collapsedGrid, rows = _a.rows, columns = _a.columns;
        var hasStubColumn = columns.some(function (col) { return col.type === TABLE_STUB_TYPE; });
        var hasStubRow = rows.some(function (row) { return row.type === TABLE_STUB_TYPE; });
        if (hasStubColumn || hasStubRow) {
            this.ref.current.setupListeners();
        }
    };
    GridSizer.prototype.render = function () {
        var _a = this.props, collapsedGrid = _a.collapsedGrid, restProps = __rest(_a, ["collapsedGrid"]);
        return createElement(Sizer, __assign({ ref: this.ref }, restProps));
    };
    return GridSizer;
}(PureComponent));
...
var VirtualTableLayout = /*#__PURE__*/ (function (_super) {
    ...
    VirtualTableLayout.prototype.render = function () {
        ...
        return (createElement(GridSizer, { onSizeChange: this.handleContainerSizeChange, containerComponent: Container, style: __assign({}, (height === AUTO_HEIGHT ? null : { height: height })), onScroll: this.onScroll, scrollTop: scrollTop, collapsedGrid: collapsedGrids.headerGrid },
