    ...
    ***************************************************************************** */
    ...
    var GridSizer = /*#__PURE__*/ (function (_super) {
        ...
        GridSizer.prototype.componentDidUpdate = function () {
            ...
            var hasStubColumn = columns.some(function (col) { return col.type === dxGridCore.TABLE_STUB_TYPE; });
            var hasStubRow = rows.some(function (row) { return row.type === dxGridCore.TABLE_STUB_TYPE; });
        ...
        GridSizer.prototype.render = function () {
            ...
            return React.createElement(dxReactCore.Sizer, __assign({ ref: this.ref }, restProps));
        };
        return GridSizer;
    }(React.PureComponent));
    ...
    var VirtualTableLayout = /*#__PURE__*/ (function (_super) {
        ...
        VirtualTableLayout.prototype.render = function () {
            ...
            return (React.createElement(GridSizer, { onSizeChange: this.handleContainerSizeChange, containerComponent: Container, style: __assign({}, (height === AUTO_HEIGHT ? null : { height: height })), onScroll: this.onScroll, scrollTop: scrollTop, collapsedGrid: collapsedGrids.headerGrid },
